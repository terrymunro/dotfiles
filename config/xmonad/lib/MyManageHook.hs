...
myManageHook = composeAll . concat $
  ...
  , [className =? c --> viewShift wsNet         | c <- myBrowser              ]
  , [className =? c --> viewShift wsEdit        | c <- myEditor               ]
  , [className =? c --> viewShift wsPlace       | c <- myPlace                ]
  , [className =? c --> viewShift wsMail        | c <- myMail                 ]
